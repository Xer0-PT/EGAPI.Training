...
namespace Acme.BookStore.Store.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        {
            await CreateApiScopeAsync("Store");
        }
        ...
        private async Task CreateApiResourcesAsync()
        {
            ...
            await CreateApiResourceAsync("Store", commonApiUserClaims);
        }
        ...
        private async Task CreateClientsAsync()
        {
            ...
            if (!webClientId.IsNullOrWhiteSpace())
            {
                ...
                /* Store_Web client is only needed if you created a tiered
            ...
            // Blazor Client
            var blazorClientId = configurationSection["Store_Blazor:ClientId"];
            if (!blazorClientId.IsNullOrWhiteSpace())
            {
                var blazorRootUrl = configurationSection["Store_Blazor:RootUrl"].TrimEnd('/');

                await CreateClientAsync(
                    name: blazorClientId,
                    scopes: commonScopes,
                    grantTypes: new[] { "authorization_code" },
                    secret: configurationSection["Store_Blazor:ClientSecret"]?.Sha256(),
                    requireClientSecret: false,
